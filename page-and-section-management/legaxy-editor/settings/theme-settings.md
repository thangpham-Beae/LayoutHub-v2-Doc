...
* **Font size**: this is the size of body text.
* **Custom CSS**: where you can safely add extra CSS to the layout which overwrites the CSS of the main stylesheet file, so that you can apply some CSS to change the look of the site as you desire. Also, this changes will still remain even if you update, publish the layout.
