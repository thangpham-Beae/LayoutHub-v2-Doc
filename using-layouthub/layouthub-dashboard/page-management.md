...
Click **Pages** on Shopify side bar to access Pages.
...
{% hint style="info" %}
Learn more about **Duplicate a page**, check [this article](../../page-and-section-management/duplicate-a-page.md).
{% endhint %}
...
In this example, the Homepage will be moved to the Trash:
