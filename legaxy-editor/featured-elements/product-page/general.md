...
![New and Sold out label](</.gitbook/assets/image (161).png>)

![Sale label](</.gitbook/assets/image (265).png>)
...
![Disable](</.gitbook/assets/image (364).png>)

![Enable](</.gitbook/assets/image (386).png>)
...
_Learn how to allocate each circle a specific color here_ [_Product Swatch color_](https://docs.layouthub.com/user-guides/ad-ons/product-swatch-color)_._
...
![](</.gitbook/assets/Screenshot_8 (2).png>)
...
![Dont have review before](</.gitbook/assets/image (394).png>)

![Have review and review details](</.gitbook/assets/image (429).png>)
...
![](</.gitbook/assets/product_tap12 (1).png>)

You will see the **PRODUCT TABS** in the **Setting** menu.

![](</.gitbook/assets/product-tab1 (1).png>)
...
_Finally, reload the product to see the result:_

![](</.gitbook/assets/product-tab11 (1).png>)
...
![](</.gitbook/assets/product-tab12 (1).png>)
...
If you don't have raw HTML available, go here to create yourself. With this code editor, you get help with easily custom size chart content [**CLICK HERE**](https://codepen.io/layouthub/pen/PowZVmw)
...
![](/.gitbook/assets/countdown.png)

However, if you are launching a promotion campaign, you would like to allocate a specific value for a specific product. So you can do that by using [Metafields Guru App.](https://apps.shopify.com/metafields-editor-2)

You can refer to this [**link**](https://www.shopify.com/partners/blog/110057030-using-metafields-in-your-shopify-theme) to understand how to use Metafields.
...
![](</.gitbook/assets/Screenshot_18 (4).png>)

**Video**: you also can follow this tutorial video here:

{% embed url="https://www.youtube.com/watch?v=WqM0fjLcYHk&t=135s" %}
...
* Besides random option, you can set countdown for each product by [metafield app](https://apps.shopify.com/metafields-editor-2?surface_detail=metafields\&surface_inter_position=1\&surface_intra_position=4\&surface_type=search). You can go refer [HERE](https://docs.layouthub.com/user-guides/add-ons/product-countdown) to know more.
